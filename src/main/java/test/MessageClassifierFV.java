...
public class MessageClassifierFV implements Serializable {
   ...
   */
  public MessageClassifierFV() throws Exception {
  ...
  public static void main(String[] options) {
    ...
    try {
      ...
      String messageFileString ="D:\\eclipse_workspace\\datasets\\deneme.txt";
