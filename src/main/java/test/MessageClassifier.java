 ...
 * https://books.google.com.tr/books?id=QTnOcZJzlUoC&pg=PA466&lpg=PA466&dq=String+classValue+%3D+Utils.getOption(%27c%27,+options);&source=bl&ots=3hkF9nSiQb&sig=sxdTuCleJRv4FW86ezQhglgKN7U&hl=tr&sa=X&ved=0ahUKEwjE1tWNp7_JAhUFmHIKHZ_9BvoQ6AEIKzAC#v=onepage&q=String%20classValue%20%3D%20Utils.getOption('c'%2C%20options)%3B&f=false
 * 
 */
...
public class MessageClassifier implements Serializable {
  ...
  public static void main(String[] options) {
    ...
    try {
      ...
      String messageName = "D:\\eclipse_workspace\\datasets\\reviews.txt";
